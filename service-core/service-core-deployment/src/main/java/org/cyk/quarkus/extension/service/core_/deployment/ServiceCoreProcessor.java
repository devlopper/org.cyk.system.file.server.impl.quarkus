package org.cyk.quarkus.extension.service.core_.deployment;
...
class ServiceCoreProcessor {
    private static final String FEATURE = "cyk-service-core";
    ...
    static {
    	addUnremovable(UNREMOVALES_NAMES
    			,org.cyk.utility.service.DataTransferObjectProcessor.class
    			,org.cyk.utility.service.server.PersistenceEntityClassGetter.class
    			);
    }
